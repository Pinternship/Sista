                    ...
                    <td>
                        @if( $user->is_admin() or $user->is_employer() )
                            <button class="tooltip button px-2 mr-1 mb-2 bg-theme-9 text-white" title="@lang('app.edit')">
                                <a href="{{route('report_final_edit', $report->id)}}" target="_blank">
                            ...
                            <button class="tooltip button px-2 mr-1 mb-2 bg-theme-4 text-white" title="@lang('app.pdf')">
                                <a href="{{route('report_final_pdf', $report->id)}}" target="_blank">
                                <span class="w-5 h-5 flex items-center justify-center">
                            ...
                            <button class="tooltip button px-2 mr-1 mb-2 bg-theme-6 text-white" title="@lang('app.delete')">
                                <a href="{{route('report_final_delete', $report->id)}}">
                                <span class="w-5 h-5 flex items-center justify-center">
        ...
        <table class="table table-report -mt-2">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <button class="tooltip button px-2 mr-1 mb-2 bg-theme-4 text-white" title="@lang('app.pdf')">
                            <a href="{{route('report_final_pdf_faculty', $report->id)}}" target="_blank">
                            <span class="w-5 h-5 flex items-center justify-center">
                                <i class="fal fa-file-pdf w-4 h-4"></i>
                            </span>
                            </a>
