...
<div class="intro-y box sm:py-20 mt-5">
    <form method="post" action="">
        ...
        <div class="px-5 sm:px-20">
            <div class="font-medium text-base">@lang('app.add_page')</div>
            <div class="gap-4 mt-5">
                <div class="intro-y col-span-12 sm:col-span-6 mb-5 {{ $errors->has('title')? 'has-error':'' }}">
                    ...
                    <input type="text" class="input w-full border flex-1 {{e_form_invalid_class('title', $errors)}}" id="title" value="{{ old('title') }}" name="title" placeholder="@lang('app.title')" required>
               ...
               <div class="intro-y col-span-12 sm:col-span-6 mb-5 {{ $errors->has('show_in_header_menu')? 'has-error':'' }}">
                    <div class="mb-2">@lang('app.show_in_header_menu')</div>
                        <input type="checkbox" class="input border mr-2" name="show_in_header_menu" value="1" {{checked('1', old('show_in_header_menu'))}}> @lang('app.yes')
               ...
               <div class="intro-y col-span-12 sm:col-span-6 mb-5 {{ $errors->has('show_in_footer_menu')? 'has-error':'' }}">
                    <div class="mb-2">@lang('app.show_in_footer_menu')</div>
                        <input type="checkbox" class="input border mr-2" name="show_in_footer_menu" value="1" {{checked('1', old('show_in_footer_menu'))}}> @lang('app.yes')
                ...
                <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                    <button type="submit" class="button w-40 justify-center block bg-theme-1 text-white">@lang('app.save_new_page')</button>
                </div>
            </div>
        </div>
    </form>
