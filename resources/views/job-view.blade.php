                ...
                <div class="col-md-8">
                    ...
                    <p>
                        @if(auth()->check() && auth()->user()->is_user())
                            @if ($applications > 0)
                                <button type="button" class="btn btn-warning"> <i class="la la-clipboard"></i> @lang('app.already_applied') </button>
                            @else
                        ...
                        @elseif(auth()->check() && auth()->user()->is_employer())
                            @if($job->applyed)
                                <button type="button" class="btn btn-warning"> <i class="la la-clipboard"></i> @lang('app.job_applied') {!! $job->applyed !!} </button>
                            @else
                                <button type="button" class="btn btn-warning"> <i class="la la-clipboard"></i> @lang('app.job_applied') 0 </button>
                            @endif
                        @else
                            <a href="{{route('auth_google')}}" class="btn btn-success" ><i class="la la-google-plus"></i> @lang('app.apply_online_redirect') </a>
                        @endif
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="box job-view-container box-shadow bg-white p-4 mb-4">
            ...
            <div class="col-md-4" style="padding-bottom: 50px;">
                @if($job->is_premium)
                    <div class="box widget-box bg-white box-shadow p-3 mb-3">
                ...
                <div class="box widget-box bg-white p-3 mb-3 box-shadow">
                    ...
                    @if($job->job_duration)
                        <p> <i class="la la-calendar-o"></i> @lang('app.job_duration') : {{$job->job_duration}} @lang('app.month')</p>
                    @endif
                ...
                <div class="box widget-box bg-white p-3">
                ...
                <form action="{{route('apply_job')}}" method="post" id="applyJob" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group {{ $errors->has('resume')? 'has-error':'' }}">
                            <label for="resume" class="control-label">@lang('app.resume'):</label>
                            <div class='file-input'>
                                <input type="file" accept=".docx,.doc,.pdf" class="form-control {{e_form_invalid_class('resume', $errors)}}" id="resume" name="resume">
                                <span class='button'>Choose</span>
                                <span class='label' data-js-label>No file selected</label>
                            </div>
                            <p class="text-muted">@lang('app.resume_file_types')</p>
